            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <article class="statistic-box green">
                        <div>
                            <div class="number text-light">{{ $total_ventas }}</div>
                            <div class="caption">
...
<script>
    ...
    const datosVentas2024 = {
        label: "Ventas - " + <?= date('Y') ?>,
        data: datas, //la data es un arreglo que debe  tener la misma cantidad de valores que etiquetas
        backgroundColor:'rgba(54, 162, 235, 0.2)', //color del borde
